...
export const transactions = sqliteTable(
  "transactions",
  {
    ...
    brokerageSplitBps: integer("brokerage_split_bps").default(3000),
    grossCommissionAmountCents: integer("gross_commission_amount_cents"),
    brokerageFeeAmountCents: integer("brokerage_fee_amount_cents"),
    agentNetCommissionCents: integer("agent_net_commission_cents"),
